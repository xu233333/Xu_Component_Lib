...
public class EntityComponentBase implements AutoSyncedComponent {
    public SerializableComponent<LivingEntity> component;

    public EntityComponentBase(SerializableComponent<LivingEntity> component) {
